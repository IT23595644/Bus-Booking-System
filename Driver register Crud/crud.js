...
//validate Licen
if (licen == '') {
    document.getElementById('licen_error').style.color = '#ff0000'; // Set error color
    document.getElementById('licen_error').innerHTML = "License is required"; // Set error message
    event.preventDefault(); // Prevent form submission
    return;
} else {
    document.getElementById('licen_error').style.color = 'rgb(0, 255, 51)'; // Set success color
    document.getElementById('licen_error').innerHTML = "Checked✅"; // Set success message
}
return;
})
